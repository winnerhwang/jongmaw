...
$(function(){
  ...
  var config = {
    ...
    form1: {
      ...
      //itemsYN   : ['Y.是','N.否'],
      fields: [
        { name  : "stk_no"  , type:"text" , required: true , html: {caption:"貨品編號", span:11 ,attr:'size="10"'} },
        { name  : "kind"    , type:"list" , required: false, html: {caption:"貨品類別", span:15 ,attr:'size="10"' },
          options:{items: [{id:'1',text:'1.鈑金'},{id:'2',text:'2.特殊'},{id:'3',text:'3.套筒'},{id:'4',text:'4.板手'},{id:'5',text:'5.引擎'},{id:'6',text:'6.機械設備'},{id:'7',text:'7.氣動'}] }},
        { name  : "sal_knd" , type:"list" , required: false, html: {caption:"內外銷別", span:15 ,attr:'size="8"' },
          options:{items: [{id:'A',text:'A.內銷'},{id:'B',text:'B.外銷'},{id:'C',text:'C.均有'}] }},
        { name  : "always"  , type:"list" , required: false, html: {caption:"永久保固", span:15 ,attr:'size="10"' },
        ...
        { name  : "unit"    , type:"text" , required: false, html: {caption:"英文單位", span:11} },
        { name  : "unitc"   , type:"text" , required: false, html: {caption:"中文單位", span:15} },
        { name  : "ntcost"  , type:"float", required: false, html: {caption:"成本價-台幣", span:11, attr:"style='text-align:right;'" } , options:{precision:"2"}  },
        { name  : "uscost"  , type:"float", required: false, html: {caption:"成本價-美金", span:15, attr:"style='text-align:right;'" } , options:{precision:"2"}  },
        { name  : "pricent" , type:"float", required: false, html: {caption:"外銷價-台幣", span:11, attr:"style='text-align:right;'"} , options:{precision:"2"}  },
        { name  : "priceus" , type:"float", required: false, html: {caption:"外銷價-美金", span:15, attr:"style='text-align:right;'"} , options:{precision:"2"}  },
        { name  : "price"   , type:"float", required: false, html: {caption:"內銷售價", span:11, attr:"style='text-align:right;'"} , options:{precision:"2"}  },
        { name  : "price1"  , type:"float", required: false, html: {caption:"優惠價"  , span:15, attr:"style='text-align:right;'"} , options:{precision:"2"}  },
        { name  : "slr_prcnt",type:"float", required:false, html: {caption:"業務抽成", span:15, attr:"style='text-align:right;'" } , options:{precision:"2"}  },
        { name  : "qty"     , type:"float", required: false, html: {caption:"庫存數量", span:11, attr:"style='text-align:right;'" } , options:{precision:"2"}  },
        { name  : "safeqty" , type:"float", required: false, html: {caption:"安全庫存-低", span:15, attr:"style='text-align:right;'" } , options:{precision:"0"}  },
        { name  : "ord_qty" , type:"float", required: false, html: {caption:"安全庫存-高", span:15, attr:"style='text-align:right;'" } , options:{precision:"0"}  },
        { name  : "netkg"   , type:"float", required: false, html: {caption:"重量-淨重", span:11, attr:"style='text-align:right;'"} , options:{precision:"2"}  },
        { name  : "grwkg"   , type:"float", required: false, html: {caption:"重量-毛重", span:15, attr:"style='text-align:right;'"} , options:{precision:"2"}  },
        { name  : "flow"    , type:"text" , required: false, html: {caption:"加工流程", span:11} },
        { name  : "flow_pri", type:"float", required: false, html: {caption:"加工單價", span:15, attr:"style='text-align:right;'"} , options:{precision:"2"}  },
        { name  : "cust_no" , type:"combo", required: false, html: {caption:"廠商"    , span:11 }, options:{url:"venm0100.php"} },
        { name  : "cust_na" , type:"text" , required: false, html: {caption:"廠名"    , span:15 } },
        { name  : "set_date", type:"date" , required: false, html: {caption:"建檔日期", span:15 } }
      ],
      ...
      actions: {
        "save": {caption:"存檔",onClick:function(event) {
            if (!spForm1('cust_no','cust_no,cust_na'))  w2alert('欄位選擇不正確');
            form1.record['kind'] = form1.record['kind'].id
            form1.record['sal_knd'] = form1.record['sal_knd'].id
            form1.record['always'] = form1.record['always'].id

            this.save(function (data) {
                if (data.status == 'success') {
                  w2ui['grid1stkm0100'].reload();
                }
            });
        }}
      }
