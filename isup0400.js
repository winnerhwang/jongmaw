  ...
  var config = {
    ...
    ,formp: {
      ...
      ,fields: [
        ...
        ,{ name : "cust_no",type:"combo",required: false, html: {caption:"廠商編號", span:11, attr:"size=20 "}, options:{url:"venm0100.php"} }
        ...
        ,{ name : "sort"  , type:"list", required: false, html: {caption:"排序", page:1, span:11 }
          , options:{items:[{id:"date,doc_no",text:"日期-單號(升冪)"},{id:"cust_no,date",text:"廠商-日期(升冪)"}
