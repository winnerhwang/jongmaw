...
$(function(){
  ...
  var config = {
    ...
    ,formp: {
      ...
      ,fields: [
         { name : "bgn_cus", type:"combo", required: true , html: {caption:"客戶  從", span:11, attr:"size=10 "}, options:{url:"cusm0100.php"} }
        ,{ name : "end_cus", type:"combo", required: true , html: {caption:"至"      , span:15, attr:"size=10 "}, options:{url:"cusm0100.php"} }
        ,{ name : "cuslist", type:"enum" , required: false, html: {caption:"客戶(複選)", span:11, attr:"size=50 "}, options:{url:"cusm0100.php"} }
        ,{ name : "addrx"  , type:"list" , required: false, html: {caption:"地址",  span:11 }
          , options:{items:[{id:"co_addr1",text:"公司地址"},{id:"co_addr2",text:"送貨地址"},{id:"co_addr3",text:"發票地址"},{id:"co_addr3",text:"住家地址"}
          ]}  }
        ,{ name : "sort"  , type:"list", required: false, html: {caption:"排序", page:1, span:11 }
          , options:{items:[{id:"cust_no",text:"客戶(升冪)"}
          ]} }
